function thisTree = forwardPropTree(sNum,sTree,sStr,Wv,Wo,W,WO, params, onlyGetVectors)
% function thisTree = forwardPropTree(sNum,sTree,sStr,sNN,Wv,Wo,W,WO, params, onlyGetVectors)
...
thisTree.nodePath = findPath( thisTree,[1 max(find(thisTree.isLeafVec))] ); 
...
catInput = [thisTree.pooledVecPath(:)];
