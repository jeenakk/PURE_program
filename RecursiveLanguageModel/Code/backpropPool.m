function [ nodeVecDeltas, paddingDelta] = backpropPool(tree, outputVector, params)
...
catInput = [tree.pooledVecPath(:)];
topDelta = catInput - outputVector; 
df_s_Wcat = topDelta; 
...
nodeDeltas = tree.poolMatrix * topDelta;
