function [cost,grad] = costFct_preTrainDual(X, decodeInfo, params, allSNum, allSStr, allSTree, targetVectors, iterTesting)
% function [cost,grad] = costFct_preTrainDual(X, decodeInfo, params, allSNum, allSStr, allSTree, targetVector, iterTesting)
% X ,decodeInfo,params,allSNum_batch,allSStr,allSTree, targetVectors

[Wv,Wo,W,WO] = stack2param(X, decodeInfo);
...
%     targetVector = Wv(:,targetVectorIndices(t));
%     [df_s_Wv,df_s_Wo,df_s_W,df_s_WO, cost] = costAndGradOneSent_preTrainDualRNN(allSNum{t},allSTree{t},allSStr{t},...
%         allSNN{t},Wv,Wo,W,WO, targetVector, params);
    [df_s_Wv,df_s_Wo,df_s_W,df_s_WO, cost] = costAndGradOneSent_preTrainDualRNN(allSNum{t},allSTree{t},allSStr{t},...
        Wv,Wo,W,WO, targetVectors(:,t), params);
...
[grad, dummy] = param2stack(Wv_df,Wo_df,W_df,WO_df);
grad = full(grad);
